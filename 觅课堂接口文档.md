...
| username  |  是  | String  |                视频ID                |
|  comment  |  是  | String  |               评论内容               |
|   reply   |  否  | Number  |         回复的评论ID，如果有         |
| timestamp |  是  | Number  |           发布的UNIX时间戳           |
|  edited   |  是  | Boolean |             是否被编辑过             |
|   like    |  是  |  Array  | 点赞这条评论的用户，每个元素是用户名 |
